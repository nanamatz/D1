...
`wj.lang`, then a sanitized `en|ko` hint only from a successfully initialized
...
- **Score-panel spacing (changed 2026-09-04):** a visible internal gap separates the ScoreBox from modifier/effects/pouch rows. The always-reserved status/transfer slot is 52px high. The 188/211/234px score-panel heights, paired 296/273/250px controls, and 484px rail total remain fixed.
