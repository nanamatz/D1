...
The ready-to-import Japanese, Simplified Chinese, Traditional Chinese, and Brazilian Portuguese achievement tokens live in
...
`steam/achievement-localization/achievement_loc_brazilian.vdf`, alongside the
existing Korean VDF. Keep all five synchronized with the table below. The
...
3. Preview English, Korean, Japanese, Simplified Chinese, Traditional Chinese, and Brazilian Portuguese independently; check truncation and punctuation.
