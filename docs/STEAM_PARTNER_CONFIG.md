...
The ready-to-import Japanese, Simplified Chinese, Traditional Chinese, Brazilian Portuguese, and German achievement tokens live in
...
`steam/achievement-localization/achievement_loc_german.vdf`, alongside the
existing Korean VDF. Keep all six synchronized with the table below. The
...
3. Preview English, Korean, Japanese, Simplified Chinese, Traditional Chinese, Brazilian Portuguese, and German independently; check truncation and punctuation.
