...
**Language.** English, Korean, Japanese, Simplified Chinese, and Traditional Chinese interface localization.
...
`tchinese` maps to Traditional Chinese,
`english` maps to English, and every unsupported or failed lookup falls back to
English. The renderer receives only `en|ko|ja|zh-CN|zh-TW`, never the raw Steam locale or
...
the saved choice or English. (Japanese and Simplified Chinese localization added 2026-09-06; Traditional Chinese added 2026-09-07.)
