...
All tooltips are vertically viewport-contained and scrollable if their translated
copy is taller than the available side. All tooltip copy uses the enlarged readability scale: 18px title, 15px body,
