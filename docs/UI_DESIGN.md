...
**Guided Palette Convenience spotlight (changed 2026-09-09):** after the first-run YELLOW settlement completes, reuse the real in-run Settings > Game surface and body-portalled coach-mark to spotlight its Palette Convenience button. The overlay blocks the button itself; Next or Skip returns to play without granting unlocks.
