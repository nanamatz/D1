...
opens, so either a revealed targeting card or a compatible Fable/Gambler already
held on the consumable shelf can use the same active field. Direct target changes
