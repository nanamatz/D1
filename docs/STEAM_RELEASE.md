...
`steam/achievement-localization/achievement_loc_polish.vdf` for Polish, and
`steam/achievement-localization/achievement_loc_turkish.vdf` for Turkish.
...
Simplified Chinese, Traditional Chinese, Brazilian Portuguese, German, Spanish (Spain), French, Russian, Polish, Turkish, and English respectively
