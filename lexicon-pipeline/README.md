...
Current playable build: 172,236 dictionary words, 172,259 lexicon entries
...
four reviewed-validity keys (`aint`, `christ`, `christmas`, `june`), and both baked outputs.
...
Standard 168,470; Formal 2,669; Slang 880; Vulgar 240.
