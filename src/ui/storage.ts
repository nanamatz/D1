...
export interface StorageBridge {
  ...
  languageHint?: 'en' | 'ko' | 'ja' | 'zh-CN' | 'zh-TW' | 'pt-BR';
...
export function steamLanguageHint(): 'en' | 'ko' | 'ja' | 'zh-CN' | 'zh-TW' | 'pt-BR' | undefined {
  const hint = getBridge()?.languageHint;
  return hint === 'en' || hint === 'ko' || hint === 'ja' || hint === 'zh-CN' || hint === 'zh-TW' || hint === 'pt-BR'
    ? hint : undefined;
}
