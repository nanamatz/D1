...
export interface StorageBridge {
  ...
  languageHint?: 'en' | 'ko' | 'ja' | 'zh-CN' | 'zh-TW' | 'pt-BR' | 'de';
...
export function steamLanguageHint(): 'en' | 'ko' | 'ja' | 'zh-CN' | 'zh-TW' | 'pt-BR' | 'de' | undefined {
  const hint = getBridge()?.languageHint;
  return hint === 'en' || hint === 'ko' || hint === 'ja' || hint === 'zh-CN' || hint === 'zh-TW' || hint === 'pt-BR' || hint === 'de'
    ? hint : undefined;
}
