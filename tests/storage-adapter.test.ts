...
describe('desktop backend (bridge present)', () => {
  ...
  it('accepts only a sanitized renderer language hint', () => {
    ...
    bridge.languageHint = 'zh-TW';
    expect(steamLanguageHint()).toBe('zh-TW');

    bridge.languageHint = 'pt-BR';
    expect(steamLanguageHint()).toBe('pt-BR');

    bridge.languageHint = 'de';
    expect(steamLanguageHint()).toBe('de');

    bridge.languageHint = 'es-ES';
    expect(steamLanguageHint()).toBe('es-ES');

    bridge.languageHint = 'fr-FR';
    expect(steamLanguageHint()).toBe('fr-FR');
    bridge.languageHint = 'ru-RU';
    expect(steamLanguageHint()).toBe('ru-RU');
    bridge.languageHint = 'pl-PL';
    expect(steamLanguageHint()).toBe('pl-PL');
    bridge.languageHint = 'tr-TR';
    expect(steamLanguageHint()).toBe('tr-TR');
