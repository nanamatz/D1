 ...
 * imports explicit Latin, Latin Extended, Cyrillic, Korean, Japanese, and Simplified/Traditional Chinese subsets only.
 *
...
const BLOCKS = [
  ...
  { name: 'Latin Extended', via: '@fontsource/*/latin-ext-*.css', ranges: [[0x0100, 0x024f]] },
  ...
  { name: 'Cyrillic', via: '@fontsource/{jost,noto-sans-kr}/cyrillic-*.css', ranges: [[0x0400, 0x052f]] },
...
function displayedCharacters() {
  ...
  for (const locale of ['en', 'ko', 'ja', 'zh-CN', 'zh-TW', 'pt-BR', 'de', 'es-ES', 'fr-FR', 'ru-RU', 'pl-PL', 'tr-TR']) {
